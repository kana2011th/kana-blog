        ...
        {featuredBlogPost !== null && (
          <div className="max-w-4xl mx-auto">
            <Link href={`/${featuredBlogPost.slug}`}>
              <a>
                <div className="rounded-none sm:rounded-lg overflow-hidden relative hover:ring ring-green-500 ring-opacity-50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 items-center">
          {blogPosts.map((blogPost, i) => (
            <Link href={`/${blogPost.slug}`}>
              <a>
                <div
                  className="rounded-none sm:rounded-lg overflow-hidden shadow-lg hover:ring ring-green-500 ring-opacity-50"
